...
export const serviceTags: ServiceTag[] = [
  { slug: "remont-lazienki", label: "Remont łazienki", category: "remonty", aliases: ["lazienka", "łazienka", "plytki", "płytki", "plytkarz", "płytkarz", "glazurnik"] },
  { slug: "remont-mieszkan", label: "Remont mieszkań", category: "remonty", aliases: ["mieszkanie", "remont"] },
  { slug: "wykonczenia-wnetrz", label: "Wykończenia wnętrz", category: "remonty", aliases: ["wykonczeniowka", "wykończeniówka", "wnetrza", "wnętrza"] },
  ...
  { slug: "malowanie", label: "Malowanie", category: "remonty", aliases: ["farby", "sciany", "ściany"] },
  ...
  { slug: "pielegnacja-ogrodu", label: "Pielęgnacja ogrodu", category: "ogrod", aliases: ["ogrod", "ogród"] },
  ...
  { slug: "udraznianie", label: "Udrażnianie", category: "serwis", aliases: ["odplyw", "odpływ", "kanalizacja"] },
...
export function filterServiceTags(query: string, selected: string[] = []): ServiceTag[] {
  ...
  return serviceTags.filter((tag) => {
    ...
    const haystack = normalizeSearch([tag.label, serviceCategoryLabels[tag.category], ...(tag.aliases || [])].join(" "));
